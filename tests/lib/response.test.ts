...
import {
  RoomNotFoundError, RoomCategoryNotFoundError,
  RoomCodeConflictError, RoomCategoryCodeConflictError,
  RoomDomainError,
} from '@/modules/rooms/domain/types';
import { TenantSettingsNotFoundError } from '@/modules/settings/domain/types';
import {
  TenantSlugError, TenantNotFoundError, TenantAccessDeniedError,
